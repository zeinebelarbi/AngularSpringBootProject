...
getAccessoiresProducts() {
  ...
  this.accessoiresProducts = allProducts.filter(
    (product) =>
      product.name.toLowerCase().includes('accessoire') &&
      (product.category === 'Articles soldés' ||
       product.category === 'Tendances' ||
