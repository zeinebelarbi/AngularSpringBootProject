...
public class JwtFilter extends OncePerRequestFilter {
	 @Autowired
	    ...
	    protected void doFilterInterna1(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
